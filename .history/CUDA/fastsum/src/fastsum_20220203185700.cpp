...
//      ths->mv2.x[ths->mv2.d * j + t] = -ths->y[ths->mv2.d * j + t]; /* note the factor -1 for conjugated transform instead of standard*/ths->target_node_loc.data = ths->y; // FIXME we need tyo take factor -1?
